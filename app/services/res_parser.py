...
from app.utils.ext_data import extract_email,extract_phone,extract_name,extract_skills,extract_education,extract_latest_degree_and_year,extract_experience
# ,extract_summary
import os
